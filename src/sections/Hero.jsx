...
const Hero = () => {
  ...
  return (
    <section className='min-h-screen w-full flex flex-col relative' id="home">
      ...
      <div className='w-full h-[92%] md:h-full absolute inset-0 -top-6 md:top-3 lg:top-6'>
            <Leva hidden/>
      ...
      <div className='absolute bottom-16 md:bottom-7 left-0 right-0 w-full z-10 c-space'>
...
// export const calculateSizes = (isSmall, isMobile, isTablet) => {
//   return {
//     deskScale: isSmall ? 0.26 : isMobile ? 0.28 : 0.32,
//   };
// };
...
//   return (
//     <section className="relative w-full h-screen flex flex-col justify-between" id="home">
//       <Sparkles />

//       {/* Top Greeting Text */}
//       <div className="px-4 pt-10 text-center z-10">
//         <p className="sm:text-3xl text-2xl font-medium text-white font-generalsans">
//           Hi, I am Shashank <span className="waving-hand">🖐</span>
//         </p>

//         <h1 className="hero_tag text-gray_gradient text-3xl md:text-5xl font-bold leading-snug mt-4">
//           Transforming&nbsp;
...
//       {/* Bottom Button */}
//       <div className="w-full px-4 pb-6 z-10">
//         <a href="#about" className="block w-full sm:w-fit sm:min-w-96 mx-auto">
//           <Button name="Enter My Digital World" isBeam containerClass="w-full" />
//         </a>
//       </div>
//     </section>
//   );
